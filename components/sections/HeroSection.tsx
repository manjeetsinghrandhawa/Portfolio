...
const HeroSection = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col md:flex-row justify-between items-center h-auto md:h-[700px] bg-black w-full rounded-2xl shadow-lg border-2 border-blue-400 transition-transform duration-300 p-6 md:p-12"
    >
      {/* Left Side - Text */}
